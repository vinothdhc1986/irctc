...
class UpiMandateTimerView extends React.Component {
    constructor(props) {
        super(props)
        ...
        $.ajax(
            {
                ...
                url: process.env.REACT_APP_PG_CONTROLLER + "api/v1/mandate/upi/GetStatusOfUPIMandateTransaction?token=" +
    ...
    render() {
        ...
        return (
            <>
                ...
                <form id="UPIAuthForm" method="POST" action={process.env.REACT_APP_PG_CONTROLLER + "UPI/SubmitUpiMandateTransaction"}  >
                        ...
                        <div class="container">
                            <div class="col-12 white-block">
                                <div class="proceesing-request text-center">
                                    ...
                                    <div class="bdr-top transaction-successful">Please click on the notification received on your<br /> UPI based Bank App & enter your bank MPIN.</div>
                                </div>
                            </div>
...
export default connect(mapStateToProps, null)(UpiMandateTimerView);