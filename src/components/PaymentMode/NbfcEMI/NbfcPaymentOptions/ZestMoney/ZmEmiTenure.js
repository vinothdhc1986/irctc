...
class ZmEmiTenure extends React.Component {
    constructor(props) {
        super(props);
        this.error = null;
        this.loading = null;
    ...
    render() {
        let tenureOptionRdId = "ZMGridTenure-" + this.props.scheme.tenure_in_months;
        return (
            <>
                    ...
                    <div className={`emi-tenure ${this.props.isSelected ? "active" : ""}`}>
                        <div class="custom-control custom-radio bdr-btm-0">
                            <input type="radio" class="custom-control-input" id={tenureOptionRdId} name="BFLTenureID"
                                onClick={() => this.props.OnZMRadioBtnClick(this.props.scheme.tenure_in_months, this.props.scheme.emi_amount)} />
...
export default connect(mapStateToProps, null)(ZmEmiTenure);
