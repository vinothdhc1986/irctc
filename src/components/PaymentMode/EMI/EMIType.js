...
export const CONST_EMI_TYPE_DATA = [
  {
    EMI_TYPE_ID: EMI_TYPE_CONST.EMI_TYPE_NO_COST_EMI,
    NAME: EMI_TYPE_CONST.EMI_TYPE_NO_COST_EMI_NAME,
    VALUE: "Easy EMIs without any additional costs",
    ROUTE_PATH: "/emi/no_cost_emi"
  },
  {
    EMI_TYPE_ID: EMI_TYPE_CONST.EMI_TYPE_LOW_COST_EMI,
    NAME: EMI_TYPE_CONST.EMI_TYPE_LOW_COST_EMI_NAME,
    VALUE: "Avail EMIs from top banks on low-interest",
    ROUTE_PATH: "/emi/low_cost_emi"
  },
  {
    EMI_TYPE_ID: EMI_TYPE_CONST.EMI_TYPE_STANDARD_COST_EMI,
    NAME: EMI_TYPE_CONST.EMI_TYPE_STANDARD_COST_EMI_NAME,
    VALUE: "Standard interest rates apply on these EMIs",
    ROUTE_PATH: "/emi/standard_emi"
  }
  //,
  ...
  //   ROUTE_PATH: "/emi/no_emi_on_cashback"
  // }

];

const d = function EMIType(props) {
