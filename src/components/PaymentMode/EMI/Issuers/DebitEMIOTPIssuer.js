...
class DebitEMIOTPIssuer extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      DebitCardNumber: "",
      ...
      .then(json => {
        ...
        if (responseData.response_code == 1) {
          ...
          this.onDebitEMICeckEleg((status, responseMsg) => {
            if (status) {
              //callbackProps.dispatch(FETCHING_MERCHANT_PAYMENT_DATA_BEGINS());
          ...
          if (this.selected_emi_data.issuerId == ISSUER_CONST.KOTAK_DEBIT_EMI_ISSUER
            ...
            this.onClickDebitEMIConfirmOtp((responseCode) => {
              if (responseCode != null) {
                ...
                document.getElementById("DebitEMIForm").submit();
              }
  ...
  onValidateOTP(callback) {
    ...
    let validateOTPData = {
      card_number: this.state.DebitCardNumber,
      scheme_id: this.schemeID,
      issuer_id: this.selected_emi_data.issuerId,
      tenure_id: this.selected_emi_data.tenureId,
      card_expiry_date: this.state.CardExpiryDate,
  ...
  render() {
    ...
    if (IssuerId == ISSUER_CONST.HDFC_DEBIT_EMI_ISSUER
      ...
      this.TermsAndConditionsNote = <div>
        ...
        Additional charges are as applicable: Late payment charges: Rs 550+GST; Auto Debit return charges: 2%+GST on EMI amount, Min of Rs. 550; Pre-closure charges: 3%+GST. GST-18% as per Govt. instructions. */}
    ...
    return (
      <>
        ...
        <div class="col-lg-12 p-0 checkeligibility clearfix">
          <h3>
            Enter card number & Bank registered Mobile number to check eligibility
          </h3>
          <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-5 col-12 mb-3  pr-2">
              <ValidatedInput
                ...
                onValueChange={values => {
                  ...
                  // this.CreditCardValidator(value)
                  //   ? this.setState({
                  //     isCardValid: true
                  //   })
                  //   : this.setState({
              ...
              />
              <label for="DebitCardNumber">Enter card no.</label>
            ...
            <div class="col-lg-5 col-md-5 col-sm-5 col-12 mb-3  pr-2">
              <ValidatedInput
                ...
                value={this.state.DebitMobileNo}
              />
              <label for="DebitMobileNo">Enter mobile no.</label>
            ...
            {isSaveCardEnabled && (CustomerId > 0) ?
              (<div className="col-12 mb-3">
                <div class="checkbox">
                  ...
                  <input
                    id="isDebitCardToBeSaved"
                    name="isDebitCardToBeSaved"
                    onChange={this.myChangeHandler}
                    type="checkbox"
                    value={this.state.isDebitCardToBeSaved}
                  />
                  <label for="isDebitCardToBeSaved">Save this card for future payments</label>
...
export default connect(mapStateToProps)(DebitEMIOTPIssuer);
