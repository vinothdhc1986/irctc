...
import { EMIType, Cards } from "../CashbackOnFullPayment";
...
class Cashback extends React.Component {
    ...
    onClickPayWithAnotherEMIType = () => {
        ...
        let defaultEMITypeId = EMI_TYPE_CONST.EMI_TYPE_NO_EMI_ONLY_CASHBACK_COST_EMI;//this.GetDefaultEmiTypeId();
    ...
    render() {
        ...
        let cashbackTypeID = EMI_TYPE_CONST.EMI_TYPE_NO_EMI_ONLY_CASHBACK_COST_EMI;
        ...
        let defaultEMITypeId = cashbackTypeID;

        // if (!selected_emi_data.emiType) {
        //     //get default id
        ...
        const dynamicEmiType =
            // (

            //     <EMIType
            //         emi_type_id={cashbackTypeID}
            //         key={cashbackTypeID}
            //         is_selected={defaultEMITypeId == cashbackTypeID}
            //         onClicked={() => this.onClickEMITypeNaviagtion(cashbackTypeID)}
        ...
        let isContainsSpecialOffers = this.objMerchantPaymentDataUtils.IsSpecialOfferExistForCashbackOnFullPayment(this.mercantPaymentData);
        ...
        if (isContainsSpecialOffers) {
            ...
            arrDetailsForSpecialOffers = this.objMerchantPaymentDataUtils.GetSpecialOfferDataForCashbackOnFullPayment(emiInfo);
            let listSpecialOfferData = this.objMerchantPaymentDataUtils.GetSpecialOfferDataForFullPaymentWithCashbackForAllProducts(merchant_payment_data);
        ...
        const emiCardData = <div>
            <h2 className="font-weight-semi-bold">Select Card type
            {/* <a class="pull-right btn-blue" data-toggle="modal" data-target="#special-offer-popup">View special offer</a> */}
